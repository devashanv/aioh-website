...
const steps = [
  {
    ...
    description:
      "Identify business challenges where AI can deliver measurable improvements.",
  },
  {
    number: "02",
    title: "Feature Prioritization",
    description:
      "Focus development on impactful AI features such as chatbots, assistants, or predictive models.",
  },
  {
    number: "03",
    title: "Progressive Development",
    description:
      "Build and train AI systems incrementally, ensuring quality through ongoing testing.",
  },
  {
    number: "04",
    title: "Integration & Insights",
    description:
      "Embed AI into business systems and gather real-world user feedback.",
  },
  {
    number: "05",
    title: "Model Optimization",
    description:
      "Refine algorithms to enhance accuracy, efficiency, and user experience.",
  },
  {
    number: "06",
    title: "Sustained Monitoring",
    description:
      "Continuously track performance and adjust models for long-term effectiveness.",
  },
];
