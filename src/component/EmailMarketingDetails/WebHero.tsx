...
import Image1 from "../../assets/serv_details/web/Email Marketing.png";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-[#02ec97]">Money-Making </span>Machine
        </motion.h1>

        <p className="text-[16px] lg:text-[20px] leading-7 lg:leading-8 text-[#191818] mt-6 font-light lg:text-left text-justify">
          You've got a list of emails sitting there doing nothing. Or
          worse—you're sending emails that nobody opens, nobody clicks, and
          nobody buys from. Maybe you don't even have a list yet and you're
          leaving money on the table every single day. Email marketing has the
          highest ROI of any digital channel when done right. We help you build
          lists, craft emails people actually want to read, and turn subscribers
