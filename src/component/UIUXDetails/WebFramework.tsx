...
const steps = [
  {
    number: "01",
    title: "Define the Project and Goals",
    description:
      "Align with stakeholders to clearly understand the product's purpose, target users, and measurable objectives.",
  },
  {
    number: "02",
    title: "Conduct In-Depth Research",
    description:
      "Gather insights through interviews, surveys, competitor analysis, and market research to identify user needs and opportunities.",
  },
  {
    number: "03",
    title: "Analyze and Synthesize Insights",
    description:
      "Create personas, map journeys, and define key problems and priorities to shape a focused project scope and strategy.",
  },
  {
    number: "04",
    title: "Ideate and Design Solutions",
    description:
      "Develop user flows, wireframes, and low-fidelity prototypes to explore ideas and collect early feedback.",
  },
  {
    number: "05",
    title: "Create High-Fidelity Designs and Prototypes",
    description:
      "Design polished UI mockups and build interactive prototypes to simulate experiences for testing and validation.",
  },
  {
    number: "06",
    title: "Conduct Usability Testing",
    description:
      "Test prototypes with real users to observe behavior, identify issues, and gather feedback.",
  },
  {
    number: "07",
    title: "Refine and Iterate Designs",
    description:
      "Incorporate user testing insights and stakeholder feedback to improve solutions iteratively.",
  },
  {
    number: "08",
    title: "Prepare for Development Handoff",
    description:
      "Document specifications, share prototypes, and provide design system components for seamless implementation.",
  },
  {
    number: "09",
    title: "Monitor Post-Launch Performance",
    description:
      "Track analytics and gather feedback post-launch to drive ongoing design improvements.",
  },
];
