...
import Image1 from "../../assets/serv_details/web/Brand Identity Development.png"
    ...
    <>
      ...
      >
        ...
        >
          Stand Out With a
          <br />
          <span className="text-[#02ec97]">Brand Identity </span> People
          Remember
        </motion.h1>

        <p className="text-[16px] lg:text-[20px] leading-7 lg:leading-8 text-[#191818] mt-6 font-light lg:text-left text-justify">
          Your business gets lost in the crowd. Customers can't tell you apart
          from competitors. Your logo looks amateur, your colors don't match,
          your messaging is all over the place. A strong brand identity isn't
          just a pretty logo—it's the complete visual and verbal language that
          makes people recognize you instantly and choose you over everyone
          else. We create cohesive brand identities that make you unforgettable.
        </p>
