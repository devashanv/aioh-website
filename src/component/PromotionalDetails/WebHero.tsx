...
import Image1 from "../../assets/serv_details/web/Promotion or POS Material Design.png";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <br />
          That Actually<span className="text-[#02ec97]"> Drive Sales</span>
        </motion.h1>

        <p className="text-[16px] lg:text-[20px] leading-7 lg:leading-8 text-[#191818] mt-6 font-light lg:text-left text-justify">
          Your flyers end up in the trash. Your banners get ignored. Your
          point-of-sale materials blend into the background instead of
          converting customers. Most promotional materials fail because they
          look generic and don't grab attention. We design POS and promotional
          materials that stop people in their tracks, communicate your offer
          clearly, and turn browsers into buyers. Every flyer, banner, and sign
          we create is built to sell.
        </p>
