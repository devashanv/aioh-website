...
import MarketingImg from '../../assets/img/sample/marketing.webp'
import TechnologyImg from '../../assets/img/sample/technology.webp'
import DesignImg from '../../assets/img/sample/design.webp'
    ...
    return (
        <>
            <section className='w-11/12 mx-auto h-full'>
                <section
                    className='h-auto lg:h-1/4 lg:mb-0 mb-10 flex items-center'>
                ...
                <section
                    ...
                    <section
                        ...
                        <section
                            className='relative h-8/12 rounded-[20px] w-full '>
                            {/* gradient */}
                            <div className="absolute bg-gradient-to-b from-[#078BD6]/44 to-[#D9D9D9]/0 h-64 w-full rounded-[20px]"></div>

                            <img src={TechnologyImg} alt="" className='w-full h-full object-cover rounded-[20px]' />
                    ...
                    <section
                        ...
                        <section
                            ...
                            <img src={DesignImg} alt="" className='w-full h-full object-cover rounded-[20px]' />
