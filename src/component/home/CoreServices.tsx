    ...
    return (
        <>
            ...
            <div
                ...
                <div
                    ...
                    <div className="flex items-center justify-center mb-4 -space-x-5">
                        {[googleImg1, googleImg2, googleImg3, googleImg4, googleImg5, plus].map(
                            (img, i) => (
                                ...
                                <img
                                    key={i}
                                    src={img}
                                    className={i === 5 ? `w-6 h-6 font-bold ml-3`: `w-10 h-10 rounded-full border-2 border-[#078BD6]`}
                                />
                            )
                        )}
                    </div>
                    <div className="text-[18px] font-medium flex flex-col">
                        <div
                            className='flex'>
                            <MdOutlineStarPurple500 style={{ height: '30px', width: '30px' }} className='text-amber-400' />
                            <MdOutlineStarPurple500 style={{ height: '30px', width: '30px' }} className='text-amber-400' />
                            <MdOutlineStarPurple500 style={{ height: '30px', width: '30px' }} className='text-amber-400' />
                            <MdOutlineStarPurple500 style={{ height: '30px', width: '30px' }} className='text-amber-400' />
                            <MdOutlineStarHalf style={{ height: '30px', width: '30px' }} className='text-amber-400' />
                        </div>
            ...
            <div
                ...
                {/* cards rows 1 */}
                <div
                    className='flex h-1/3 gap-3'>
                    {/* cards */}
                    <div
                        className='w-1/2 rounded-xl hover:cursor-pointer hover:bg-gradient-to-r hover:from-[#078BD6]/30 hover:to-[#02EC97]/30 p-5 text-left flex flex-col gap-2'>
                        <div
                            className="h-1/5">
                            <img src={light} alt="" />
                        </div>
                        <div
                            ...
                            <p className='font-medium text-sm lg:text-lg lg:mt-0 mt-3'>Shaping the Future with IT Excellence</p>
                        </div>
                        <div
                            className="h-2/5">
                            <p className="font-thin text-xs lg:text-lg">Empowering brands to flourish online with cutting-edge IT solutions</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            className="h-2/5 flex items-end">
                            <p className='font-medium text-sm lg:text-lg lg:mt-0 mt-3'>Transforming Ideas into Digital Marvels</p>
                        </div>
                        <div
                            className="h-2/5">
                            <p className="font-thin text-xs lg:text-lg">Empowering Building digital marvels with tailored web solutions</p>
                        </div>
                    </div>
                </div>
