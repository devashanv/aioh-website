...
import Image1 from "../../assets/serv_details/web/Test Automation Solutions.png";
  ...
  return (
    <>
      ...
      >
        ...
        >
          Automate Precise, Reliable
          <br />
          <span className="text-[#02ec97]">Testing</span> Solutions
        </motion.h1>

        <p className="text-[16px] lg:text-[20px] leading-7 lg:leading-8 text-[#191818] mt-6 font-light lg:text-left text-justify">
          Elevate your software quality and reliability with comprehensive
          automated testing solutions covering functional, regression, and
          performance testing, integrated seamlessly into your development
          pipeline.
        </p>
