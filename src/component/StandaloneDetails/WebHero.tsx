...
import Image1 from "../../assets/serv_details/web/Standalone System Development.png";
  ...
  return (
    <>
      ...
      >
        ...
        >
          Create Powerful, Standalone 
          <br />
          <span className="text-[#02ec97]">Software</span> Solutions
        </motion.h1>
