...
const NavBar: React.FC<NavProps> = ({ currentPath }) => {
                            ...
                            {navItems.map(({ label, to, submenu }) => {
                                ...
                                return (
                                    ...
                                    >
                                        <NavLink
                                            to={to}
                                            className={`flex items-center hover:text-[#02EC97] transition ${active ? "text-[#02EC97]" : "text-white/80"
                                                }`}
                                        >
                                            {label}
                                            {submenu && (
                                                <img
                                                    src={arrowIcon}
                                                    alt="Arrow"
                                                    className={`ml-1 w-2 transition-transform ${dropdownOpen === label ? "rotate-90" : ""
                                                        }`}
                                                />
                                            )}
                                        </NavLink>
                                        <span
                                            className={`absolute bottom-[-6px] left-1/2 h-[2px] bg-[#02EC97] transition-all transform -translate-x-1/2 ${active ? "w-4" : "w-0"
                                                }`}
                                        />
                                    </li>
                                );
                                        ...
                                        <div className="w-full flex justify-center py-2">
                                            {submenu ? (
                                                <div className="flex items-center gap-2 text-white">
                                                    ...
                                                    >
                                                        ...
                                                        <img
                                                            src={arrowIcon}
                                                            alt="Arrow"
                                                            className={`w-4 h-4 transition-transform ${dropdownOpen === label ? "rotate-90" : ""
                                                                } ml-1`}
                                                        />
                                                    </span>
                                                </div>
                                                ...
                                                <NavLink
                                                    ...
                                                    className={`${currentPath === to ? "text-[#02EC97]" : "text-white"
                                                        }`}
                                                >
                                                    {label}
                                                </NavLink>
