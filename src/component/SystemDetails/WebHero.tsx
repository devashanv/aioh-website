...
import Image1 from "../../assets/serv_details/web/Web System Development.png";
  ...
  return (
    <>
      ...
      >
        ...
        >
          Develop Custom, Efficient 
          <br />
          <span className="text-[#02ec97]">Web</span> Systems
        </motion.h1>

        <p className="text-[16px] lg:text-[20px] leading-7 lg:leading-8 text-[#191818] mt-6 font-light lg:text-left text-justify">
Transform everyday business operations into sleek, automated workflows through tailored web
applications from employee management to e-commerce and event coordination.
        </p>
