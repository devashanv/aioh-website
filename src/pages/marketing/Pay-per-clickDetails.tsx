...
import WebHero from "../../component/Pay-per-clickDetails/WebHero";
import WebFramework from "../../component/Pay-per-clickDetails/WebFramework";
import WebContact from "../../component/common/DetailsPageContact";
import WebRecentWork from "../../component/Pay-per-clickDetails/RecentWork";
import ChatWithUsButton from "../../component/common/ChatWithUsButton";

function PayPerClickService() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
export default PayPerClickService;
